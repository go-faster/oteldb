...
(
	...
	`attr_aws_ecs_launchtype`                            Enum8('' = 0, 'ec2' = 1, 'fargate' = 2),
	...
	`attr_db_cassandra_consistency_level`                Enum8('' = 0, 'all' = 1, 'each_quorum' = 2, 'quorum' = 3, 'local_quorum' = 4, 'one' = 5, 'two' = 6, 'three' = 7, 'local_one' = 8, 'any' = 9, 'serial' = 10, 'local_serial' = 11),
	...
	`attr_db_cosmosdb_connection_mode`                   Enum8('' = 0, 'gateway' = 1, 'direct' = 2),
	...
	`attr_disk_io_direction`                             Enum8('' = 0, 'read' = 1, 'write' = 2),
	...
	`attr_ios_state`                                     Enum8('' = 0, 'active' = 1, 'inactive' = 2, 'background' = 3, 'foreground' = 4, 'terminate' = 5),
	`attr_jvm_buffer_pool_name`                          String,
	`attr_jvm_gc_action`                                 String,
	`attr_jvm_gc_name`                                   String,
	`attr_jvm_memory_pool_name`                          String,
	`attr_jvm_memory_type`                               Enum8('' = 0, 'heap' = 1, 'non_heap' = 2),
	`attr_jvm_thread_state`                              Enum8('' = 0, 'new' = 1, 'runnable' = 2, 'blocked' = 3, 'waiting' = 4, 'timed_waiting' = 5, 'terminated' = 6),
	...
	`attr_log_iostream`                                  Enum8('' = 0, 'stdout' = 1, 'stderr' = 2),
	`attr_log_record_uid`                                String,
	`attr_message_type`                                  Enum8('' = 0, 'SENT' = 1, 'RECEIVED' = 2),
	...
	`attr_messaging_rocketmq_consumption_model`          Enum8('' = 0, 'clustering' = 1, 'broadcasting' = 2),
	`attr_messaging_rocketmq_message_group`              String,
	`attr_messaging_rocketmq_message_tag`                String,
	`attr_messaging_rocketmq_message_type`               Enum8('' = 0, 'normal' = 1, 'fifo' = 2, 'delay' = 3, 'transaction' = 4),
	...
	`attr_network_io_direction`                          Enum8('' = 0, 'transmit' = 1, 'receive' = 2),
	...
	`attr_opentracing_ref_type`                          Enum8('' = 0, 'child_of' = 1, 'follows_from' = 2),
	`attr_otel_scope_name`                               String,
	`attr_otel_scope_version`                            String,
	`attr_otel_status_code`                              Enum8('' = 0, 'OK' = 1, 'ERROR' = 2),
	`attr_otel_status_description`                       String,
	`attr_peer_service`                                  String,
	`attr_pool_name`                                     String,
	`attr_rpc_connect_rpc_error_code`                    Enum8('' = 0, 'cancelled' = 1, 'unknown' = 2, 'invalid_argument' = 3, 'deadline_exceeded' = 4, 'not_found' = 5, 'already_exists' = 6, 'permission_denied' = 7, 'resource_exhausted' = 8, 'failed_precondition' = 9, 'aborted' = 10, 'out_of_range' = 11, 'unimplemented' = 12, 'internal' = 13, 'unavailable' = 14, 'data_loss' = 15, 'unauthenticated' = 16),
	...
	`attr_state`                                         Enum8('' = 0, 'idle' = 1, 'used' = 2),
	...
	`attr_system_filesystem_state`                       Enum8('' = 0, 'used' = 1, 'free' = 2, 'reserved' = 3),
	`attr_system_filesystem_type`                        String,
	`attr_system_memory_state`                           String,
	`attr_system_network_state`                          Enum8('' = 0, 'close' = 1, 'close_wait' = 2, 'closing' = 3, 'delete' = 4, 'established' = 5, 'fin_wait_1' = 6, 'fin_wait_2' = 7, 'last_ack' = 8, 'listen' = 9, 'syn_recv' = 10, 'syn_sent' = 11, 'time_wait' = 12),
	`attr_system_paging_direction`                       Enum8('' = 0, 'in' = 1, 'out' = 2),
	`attr_system_paging_state`                           Enum8('' = 0, 'used' = 1, 'free' = 2),
	`attr_system_paging_type`                            Enum8('' = 0, 'major' = 1, 'minor' = 2),
	...
	`res_android_state`                                  Enum8('' = 0, 'created' = 1, 'background' = 2, 'foreground' = 3),
	...
	`res_faas_trigger`                                   Enum8('' = 0, 'datasource' = 1, 'http' = 2, 'pubsub' = 3, 'timer' = 4, 'other' = 5),
